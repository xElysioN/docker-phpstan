ARG PHPSTAN_VERSION=2.2.13
FROM ghcr.io/phpstan/phpstan:${PHPSTAN_VERSION}-php8.5

ARG PHPSTAN_VERSION
ARG PHPSTAN_SYMFONY_VERSION=2.0.20
ARG PHPSTAN_DOCTRINE_VERSION=2.0.28
ARG PHPSTAN_PHPUNIT_VERSION=2.0.18
